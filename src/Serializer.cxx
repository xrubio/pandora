...
Serializer::Serializer( const SpacePartition & scheduler, const Config & config ) : _config(config), _scheduler(scheduler), _agentsFileId(-1), _fileId(-1), _currentAgentDatasetId(-1)
{
}
